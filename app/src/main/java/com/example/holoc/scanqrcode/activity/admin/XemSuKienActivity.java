...
//Toast.makeText(XemSuKienActivity.this,mangdsdd.get(i).getMssv()+"",Toast.LENGTH_SHORT).show();
        ...
        tb.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(XemSuKienActivity.this, MainActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
     /*   switch (item.getItemId()){
            case R.id.menuSearch:
             //  Intent intentDM = new Intent(XemSuKienActivity.this, DanhSachDangKyActivity.class);
